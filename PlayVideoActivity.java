...
public class PlayVideoActivity extends AppCompatActivity {
    ...
    public static final String STREAM_URL = "video_url";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mediaController == null) {
            ...
            //also solves https://github.com/theScrabi/TubeMate/issues/99
        ...
        try {
            actionBar.setTitle(intent.getStringExtra(VIDEO_TITLE));
